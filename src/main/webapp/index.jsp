...
<%--访问项目就要展示员工列表页面，直接转发到list.jsp进行展示--%>
...
<%--<body>--%>
    ...
    <%--<a href="${pageContext.request.contextPath}/hello/hello">TO SUCCESS</a><br/>--%>
    <%--<a href="${ctp}/hello/hello">TO SUCCESS</a><br/>--%>
    ...
    <%--<form action="handle05/1" method="post">--%>
